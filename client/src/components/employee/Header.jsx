  ...
  return (
    <div className="flex justify-between items-center rounded-md shadow py-4 mx-8 sm:px-8 bg-white">
      ...
      <div className="flex items-center space-x-3">
        <Link to="/users/dashboard" className={linkClasses("/users/dashboard")}>
          <i className="bx bx-dashboard-alt text-xl mr-2"></i>
          <h1>Dashboard</h1>
        </Link>
        <Link to="/users/records" className={linkClasses("/users/records")}>
          <i className="bx bx-list-square text-xl mr-2"></i>
          <h1>Records</h1>
        </Link>
        <Link to="/users/history" className={linkClasses("/users/history")}>
          <i className="bx bx-list-square text-xl mr-2"></i>
          <h1>History</h1>
        </Link>
        <button
